...
class Brakecommand102 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  Brakecommand102* set_brake_pedal_en_ctrl(
  ...
  Brakecommand102* set_brake_pedal_cmd(int brake_pedal_cmd);
 ...
 private:
  Brake_command_102::Brake_pedal_en_ctrlType brake_pedal_en_ctrl_;
