...
class Turnsignalcommand104 : public ::apollo::drivers::canbus::ProtocolData<
                                 ::apollo::canbus::ChassisDetail> {
 public:
  static const int32_t ID;

  Turnsignalcommand104();
  ...
  Turnsignalcommand104* set_turn_signal_cmd(
 ...
 private:
  Turnsignal_command_104::Turn_signal_cmdType turn_signal_cmd_;
};
