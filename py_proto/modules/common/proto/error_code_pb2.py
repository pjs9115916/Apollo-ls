...
_ERRORCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HTTP_LOGIC_ERROR', index=31, number=10000,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HTTP_RUNTIME_ERROR', index=32, number=10001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STORYTELLING_ERROR', index=37, number=14000,
      options=None,
      type=None),
  ],
