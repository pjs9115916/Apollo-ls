...
class Controlcommand100 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // 'physical_unit': ''}
  Controlcommand100* set_ctrl_cmd(Control_command_100::Ctrl_cmdType ctrl_cmd);
 ...
 private:
  Control_command_100::Ctrl_cmdType ctrl_cmd_;
};
