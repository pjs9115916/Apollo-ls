...
Turnsignalstatus204::Turnsignalstatus204() {}
const int32_t Turnsignalstatus204::ID = 0x204;

void Turnsignalstatus204::Parse(const std::uint8_t* bytes, int32_t length,
                                ChassisDetail* chassis) const {
  chassis->mutable_ls()->mutable_turnsignal_status__204()->set_turn_signal_sts(
