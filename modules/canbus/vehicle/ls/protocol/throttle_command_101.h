...
class Throttlecommand101 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // 'physical_unit': ''}
  Throttlecommand101* set_throttle_pedal_en_ctrl(
  ...
  Throttlecommand101* set_throttle_pedal_cmd(int throttle_pedal_cmd);
