...
namespace canbus {
namespace ls {
class Turnsignalstatus204Test : public ::testing::Test {
 public:
  virtual void SetUp() {}
};

TEST_F(Turnsignalstatus204Test, General) {
  uint8_t data[8] = {0x01, 0x02, 0x03, 0x04, 0x11, 0x12, 0x13, 0x14};
  int32_t length = 8;
  ChassisDetail cd;
  Turnsignalstatus204 turnsignalstatus;
  ...
  EXPECT_EQ(cd.ls().turnsignal_status__204().turn_signal_sts(), 1);
}
