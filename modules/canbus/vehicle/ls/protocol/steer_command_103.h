...
class Steercommand103 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 public:
  ...
  // 'physical_unit': ''}
  Steercommand103* set_steer_angle_en_ctrl(
  ...
  Steercommand103* set_steer_angle_cmd(double steer_angle_cmd);
 ...
 private:
  Steer_command_103::Steer_angle_en_ctrlType steer_angle_en_ctrl_;
